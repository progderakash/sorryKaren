...
<head>
  ...
  <title>Sorry Galaxy for Karen</title>
  <style>
...
<body>
  ...
  <div class="sky" role="main">
    ...
    <div class="title">
      <h1>Sorry Galaxy — for Karen</h1>
      <p>Tap the stars. Each one holds a piece of my heart and an apology.</p>
    </div>
    ...
    <div class="hint">Tap any twinkling star to read a message • Swipe up to reveal more stars</div>
  </div>
  ...
  <script>
    const messages = [
      "Hey Karen — the night feels empty without your smile.",
      ...
      "You deserve gentle words and kind actions — I will be better.",
      "You are the moon to my ocean — I get pulled to you even when I stray.",
      ...
      "Thank you for the patience you've shown — I don't take it for granted.",
      "If love is a sky, I want to repaint it with care and truth.",
      "Forgive me and let me show you how much you mean to me.",
      "I am sorry. My intentions are never bad for you — only love."
    ];
    ...
    function showMessage(i,starEl){
      ...
      if(idx===messages.length-1){
        ...
        btn.innerText='Forgive me, Karen 💖';
    ...
    playBtn.addEventListener('click',async()=>{
      try{
        if(!isPlaying){await music.play();isPlaying=true;playBtn.innerText='Pause Music ♫';}
        else{music.pause();isPlaying=false;playBtn.innerText='Play Music ♫';}
